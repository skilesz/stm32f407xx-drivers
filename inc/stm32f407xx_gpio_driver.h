...
typedef struct {
	...
	uint8_t GPIO_PinMode;					// Pin mode									@GPIO_MODES
	uint8_t GPIO_PinSpeed;					// Pin speed								@GPIO_SPEEDS
	uint8_t GPIO_PinPuPd;					// Pin pull-up or pull-down configuration	@GPIO_PUPD
	uint8_t GPIO_PinOutputType;				// Pin output type							@GPIO_OUTPUT_TYPES
	uint8_t GPIO_PinAltFunMode;				// Pin alternate function mode				0 - 15
} GPIO_PinConfig_t;
